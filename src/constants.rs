...
pub const COMPARATOR_START_WITH: &str = "startWith";
pub const COMPARATOR_NOT_START_WITH: &str = "!startWith";
pub const COMPARATOR_END_WITH: &str = "endWith";
pub const COMPARATOR_NOT_END_WITH: &str = "!endWith";
